...
import { useAddAreaMutation } from "../../../components/APIs/Areas/AREAS_RTK_QUERY";
...
const AddArea = ({ open, close, t }: areaPropsType) => {
  const { lang } = useAppSelector((state) => state?.lang);
  const [addArea, { isLoading }] = useAddAreaMutation();
  const {
    data: cities,
