  ...
  return (
    <div className="edit-package-wrapper">
      ...
      >
        ...
        <section className="delete-package mt-4  ">
          <Button className="flex items-center gap-2 font-medium text-mainRed border-none shadow-none capitalize">
            <span>
        ...
        <section className="w-full mt-6 flex items-center justify-center">
          <Button
            htmlType="submit"
            className="lg:min-w-[200px] p-5 bg-mainColor text-white capitalize"
          >
            {t("UPDATE")}
          </Button>
        </section>
